# Autogenerated wrapper script for Glib_jll for armv6l-linux-musleabihf
...
function __init__()
    JLLWrappers.@generate_init_header(Libiconv_jll, Libffi_jll, GettextRuntime_jll, PCRE2_jll, Zlib_jll, Libmount_jll)
